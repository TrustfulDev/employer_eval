        ...
        <>
            <section className="h-screen flex justify-center items-center gap-9 mx-4">
                ...
                <div className="">
                    ...
                    {!uid ? ( 
                                ...
                                <h3 className="xsm:text-[15px]">Enjoy Unveiling the Truth <span className="bg-purple-700 rounded-tl-[25px] rounded-br-[25px] rounded-[5px] p-4 ml-2 xsm:ml-0 ease-in-out duration-150 hover:bg-purple-600">Take Control</span></h3>
                            )
                        }
                </div>
            ...
            <section id="join-us" className="min-h-screen h-full flex flex-col justify-center align-center px-4 relative lg:px-2 black-gradient">
                {!uid ? ( 
                        ...
                        <h1 className="text-6xl text-center font-bold absolute top-20 w-full lg:relative lg:top-0 lg:my-5 md:text-4xl">Thanks for Joining The Family</h1> 
                    )
                }
