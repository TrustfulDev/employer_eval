    ...
    return (
        <div className ="pt-20 px-56">
            ...
            <div class="w-full max-w-md">
                <form className="black-gradient shadow-md rounded px-8 pt-6 pb-8 mb-4" id='sign-up-form'>
                    ...
                    <div className="flex justify-center">
                        <button type='submit' onClick={signUp} className="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-40 rounded mb-4">Sign Up</button>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <h4 className="text-white text-lg">Already have an account? 
                            <Link className="text-purple-500 text-lg font-bold" to='/login'> SIGN IN</Link>
                        </h4>
                    </div> 
                </form>
            </div>
